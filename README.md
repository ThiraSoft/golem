...
|---|---|---|
| [`gemma/`](gemma/) | Gemma 4 E2B and 12B, from a GGUF | E2B: 21.5 tokens/s generated, 134 read — llama.cpp on the same CPU: 22.3 and 172. 12B: 4.74 and 27.0, against 4.81 and 29.8 |
