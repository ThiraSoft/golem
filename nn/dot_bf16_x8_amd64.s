...
TEXT ·dotBF16x2x4AVX2(SB), NOSPLIT, $0-48
	...
	// Sixteen elements an iteration rather than eight: the loop's own
	// bookkeeping and its prefetch are four instructions, and against eight
	// multiply-accumulates that is enough to make the front end the limit
	// rather than the multiply units.
c16:
	...
	VPMOVZXWD 16(SI)(AX*2), Y8
	VPSLLD    $16, Y8, Y8
	VPMOVZXWD 16(R11)(AX*2), Y9
	VPSLLD    $16, Y9, Y9

	VMOVUPS     32(R12)(AX*4), Y10
	VFMADD231PS Y10, Y8, Y0
	VFMADD231PS Y10, Y9, Y4
	VMOVUPS     32(R13)(AX*4), Y11
	VFMADD231PS Y11, Y8, Y1
	VFMADD231PS Y11, Y9, Y5
	VMOVUPS     32(R14)(AX*4), Y12
	VFMADD231PS Y12, Y8, Y2
	VFMADD231PS Y12, Y9, Y6
