...
// dotQ4_0x4 does the same for four consecutive columns, which is what makes
// reading a prompt cheaper than reading it a token at a time: the row is
// unpacked once for the four. Its state is the four eight-lane sums followed by
